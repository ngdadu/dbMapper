...
namespace ExpressProfiler
{
    ...
    public partial class TraceProperties : Form
    {
                               ...
                               ,Filters =  new TraceFilters
                                               {
                                                  ...
                                                  ObjectNameFilterCondition = Filters.ObjectNameFilterCondition
                                              }
                           }
                    ;
            }
        ...
        public class TraceEventsColumns
        {
            ...
            [Description(@"The name of the client workstation that created the connection to an instance of SQL Server.")]
            [DefaultValue(false)]
...
//            [DefaultValue(5000)]
            ...
            [Category(@"ObjectName")]
            [DisplayName(@"Condition")]
            public StringFilterCondition ObjectNameFilterCondition { get; set; }
            [Category(@"ObjectName")]
            [DisplayName(@"Value")]
        ...
        {
            global::DBMapper.Properties.Settings.Default.TraceSettings = m_currentsettings.GetAsXmlString();
            global::DBMapper.Properties.Settings.Default.Save();
        }
